...
# Load YOLOv3 model
yolo_net = cv2.dnn.readNet(r"C:/Users/punee/OneDrive/Documents/codeclause/yolov3.weights", r"C:/Users/punee/OneDrive/Documents/codeclause/yolov3.cfg")

# Load class labels
yolo_classes = []
with open(r'C:/Users/punee/OneDrive/Documents/codeclause/coco.names', 'r') as f:
...
def perform_yolo_detection(img):
    ...
    for i in indexes.flatten():
        ...
        draw.rounded_rectangle((x + 3, y - 20, x + label_width + 3, y + 2), radius=5, fill=color, outline=color,
                               width=3)
...
video_capture = cv2.VideoCapture(r"C:/Users/punee/OneDrive/Documents/codeclause/video.mp4")
while True:
